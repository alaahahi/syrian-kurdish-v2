                ...
                <form action="{{ route('membership.submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    <label for="nameKurdish"
                                        class="form-label">{{ trans('text.full_name_kurdish') }}</label>
                                    <input type="text" class="form-control" id="nameKurdish" name="nameKurdish"
                                        placeholder="{{ trans('text.placeholder_kurdish') }}">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="nameArabic" name="nameArabic"
                                        placeholder="{{ trans('text.placeholder_arabic') }}">
                                </div>
                                <div class="col-md-4">
                                    <label for="nameEnglish"
                                        class="form-label">{{ trans('text.full_name_english') }}</label>
                                    <input type="text" class="form-control" id="nameEnglish" name="nameEnglish"
                                        placeholder="{{ trans('text.placeholder_english') }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    <label for="birthPlaceDate"
                                        class="form-label">{{ trans('text.birth_place_date') }}</label>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="bloodType" name="bloodType"
                                        placeholder="{{ trans('text.blood_type_placeholder') }}">
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="residenceAddress"
                                    class="form-label">{{ trans('text.residence_address') }}</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber"
                                    placeholder="{{ trans('text.phone_number_placeholder') }}">
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">{{ trans('text.email') }}</label>
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="{{ trans('text.email_placeholder') }}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control" id="facebookLink" name="facebookLink"
                                    placeholder="{{ trans('text.facebook_link_placeholder') }}">
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="graduationDate"
                                    class="form-label">{{ trans('text.graduation_date') }}</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control mb-2" id="KurdishLang" name="KurdishLang"
                                    placeholder="{{ trans('text.proficiency_degree') }}">
                                <input type="text" class="form-control" id="KurdishLangCertifications"
                                    name="KurdishLangCertifications"
                                    placeholder="{{ trans('text.certifications_if_any') }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">{{ trans('text.arabic') }}</label>
                                <input type="text" class="form-control mb-2" id="ArabicLang" name="ArabicLang"
                                    placeholder="{{ trans('text.proficiency_degree') }}">
                                <input type="text" class="form-control" id="ArabicLangCertifications"
                                    name="ArabicLangCertifications"
                                    placeholder="{{ trans('text.certifications_if_any') }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">{{ trans('text.english') }}</label>
                                <input type="text" class="form-control mb-2" id="EnglishLang" name="EnglishLang"
                                    placeholder="{{ trans('text.proficiency_degree') }}">
                                <input type="text" class="form-control" id="EnglishLangCertifications"
                                    name="EnglishLangCertifications"
                                    placeholder="{{ trans('text.certifications_if_any') }}">
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="pastExperiences"
                                    class="form-label">{{ trans('text.past_experiences') }}</label>
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label"
                                    for="agreement">{{ trans('text.agreement_label') }}</label>
                            </div>
                            ...
                            <div class="text-center mt-5">
                                <button type="submit"
                                    class="btn default-btn">{{ trans('text.submit_request') }}</button>
                            </div>
                        </form>
                        @if ($errors->any())
